...
const NAV_MODULES: NavModule[] = [
      ...
      },
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: "자막 입력",
            description: "자막 작성 화면으로 바로 이동합니다.",
          },
        ],
      },
    ],
  ...
  },
  {
    ...
    roles: ["master", "final_approver", "editor", "member"],
    defaultHref: "/worship/orders",
    homeLabel: "예배 순서",
    matchPrefixes: ["/worship"],
    groups: [
      {
        id: "worship-preparation",
        label: "예배 준비",
        items: [
          {
            id: "worship-orders",
            href: "/worship/orders",
            label: "예배 순서",
            description: "예배 순서를 배치하고 준비합니다.",
          },
        ],
      },
      {
        id: "worship-subtitles",
        label: "자막 운영",
        items: [
          {
            id: "worship-subtitles-input",
            href: "/worship/subtitles/input",
            label: "자막 입력",
            description: "자막 내용을 작성합니다.",
          },
          {
            id: "worship-subtitles-output",
            href: "/worship/subtitles/output",
            label: "자막 출력",
            description: "디스플레이 송출 흐름을 확인합니다.",
          },
        ],
      },
      {
