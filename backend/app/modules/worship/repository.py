    ...
    return [
        {
            ...
            "fields": [
                _field_spec("songTitle", "곡 제목", "song_search", binding="title"),
                _field_spec("lyrics", "가사", "lyrics"),
                _field_spec("slideTemplateKey", "슬라이드 템플릿", "slide_template", binding="slideTemplateKey", required=False),
            ],
            "is_active": True,
        },
        {
            ...
            "fields": [
                _field_spec("title", "특송 제목", "text", binding="title"),
                _field_spec("lyrics", "가사", "lyrics"),
                _field_spec("slideTemplateKey", "슬라이드 템플릿", "slide_template", binding="slideTemplateKey", required=False),
            ],
            "is_active": True,
        },
        {
            ...
            "tips": "예: 요한복음 3:16-17",
            "fields": [
                _field_spec("reference", "본문", "scripture", binding="detail"),
                _field_spec("slideTemplateKey", "슬라이드 템플릿", "slide_template", binding="slideTemplateKey", required=False),
            ],
            "is_active": True,
        },
        {
            ...
            "label": "말씀 메모 입력",
            "description": "설교 메모와 템플릿을 입력합니다.",
            "tips": "메모는 운영팀과 방송팀 확인용입니다.",
            "fields": [
                _field_spec("notes", "메모", "textarea", binding="notes", required=False),
                _field_spec("slideTemplateKey", "슬라이드 템플릿", "slide_template", binding="slideTemplateKey", required=False),
            ],
            "is_active": True,
        },
        {
            ...
            "fields": [
                _field_spec("title", "제목", "text", binding="title"),
                _field_spec("body", "내용", "textarea", binding="detail", required=False),
                _field_spec("slideTemplateKey", "슬라이드 템플릿", "slide_template", binding="slideTemplateKey", required=False),
            ],
            "is_active": True,
        },
        {
            ...
            "fields": [
                _field_spec("title", "제목", "text", binding="title"),
                _field_spec("body", "기도문", "textarea", binding="detail", required=False),
                _field_spec("slideTemplateKey", "슬라이드 템플릿", "slide_template", binding="slideTemplateKey", required=False),
            ],
            "is_active": True,
        },
